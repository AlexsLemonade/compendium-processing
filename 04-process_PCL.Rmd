...
Originally, I intended to test the order in which we quantile normalized things,
but after reviewing my notes, I realized that the way quantile normalization
is implemented in our system assumes that values will be missing at random 
and we'll want to impute prior to quantile normalization.
...
```{r}
write_five_pcl <- function(exprs_mat, path, seed, missing_type = "MCAR") {
