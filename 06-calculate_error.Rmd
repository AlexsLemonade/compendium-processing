...
imputer_types <- c("IterativeSVD", "KNN_fancyimpute", "knnimpute", 
                   "softimpute")
```
...
error_df <- error_df %>%
  ...
  dplyr::mutate(imputation_method = 
                  dplyr::recode(
                    imputation_method, "KNN_fancyimpute" = "KNN (fancyimpute)",
...
error_df %>%
  ...
  ggplot2::facet_wrap(missing_type ~ imputation_method, ncol = 4) +
  ggplot2::theme_bw() +
