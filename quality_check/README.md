...
We [process RNA-seq data in a manner that captures some information about gene length](http://docs.refine.bio/en/latest/main_text.html#tximport), but can not account for short genes having fewer observations.
