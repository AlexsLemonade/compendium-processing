# Adapted from
# https://github.com/AlexsLemonade/refinebio/blob/e0d8c5ac4447b9d0dbc506c6a3dbd614040309e8/workers/data_refinery_workers/processors/tximport.R
...
sf_files <- list.files(file_list, recursive = TRUE, full.names = TRUE,
                       pattern = "quant.sf")
...
gene2tx_df <- readr::read_tsv(gene2tx_file)
